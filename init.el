...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ef-themes parrot grandshell-theme zone-nyan zig-mode yafolding which-key vterm vertico utop typescript-mode treesit-auto swift-mode solarized-theme sml-mode selectric-mode rust-mode rfc-mode rainbow-mode rainbow-delimiters pulsar powerline pdf-tools pacmacs org-roam-ui org-modern org-download orderless nyan-mode nim-mode nerd-icons-dired nerd-icons-corfu mixed-pitch mini-modeline merlin-eldoc marginalia magit lsp-mode listen ligature landmark kotlin-mode keycast irony-eldoc htmlize haskell-mode gruvbox-theme graphviz-dot-mode golden-ratio go-mode go glsl-mode fish-mode fireplace esup dune d-mode corfu consult chess c-eldoc bongo autotetris-mode auto-dark 2048-game))
